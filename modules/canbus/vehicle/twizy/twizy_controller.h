...
#ifndef MODULES_CANBUS_VEHICLE_TWIZY_TWIZY_PROTOCOL_MANAGER_H_
#define MODULES_CANBUS_VEHICLE_TWIZY_TWIZY_PROTOCOL_MANAGER_H_
...
class TwizyController final : public VehicleController {
 public:

  explicit TwizyController() {};

  virtual ~TwizyController();
...
#endif  // MODULES_CANBUS_VEHICLE_TWIZY_TWIZY_PROTOCOL_MANAGER_H_
